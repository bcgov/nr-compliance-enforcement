...
SELECT
  ...
  'Enables the high level navigation to investigations and investigation details.',
  300,
  'Y',
  user,
  now(),
...
SELECT
  'INSPECTION',
  'Enable Inspections',
  'Enables the high level navigation to inspections and inspection details.',
  300,
  'Y',
  user,
  now(),
