...
export const STREAM_TOPICS = {
  COMPLAINTS: `${process.env.COMPLAINT_STREAM_NAME}.new_complaints`,
  STAGING_COMPLAINTS: `${process.env.COMPLAINT_STREAM_NAME}.new_staging_complaints`,
  COMPLAINT_UPDATE: `${process.env.COMPLAINT_STREAM_NAME}.updated_complaints`,
  STAGING_COMPLAINT_UPDATE: `${process.env.COMPLAINT_STREAM_NAME}.new_staging_complaint_update`,
  STAGE_ACTION_TAKEN: `${process.env.COMPLAINT_STREAM_NAME}.stage-action-taken`,
  STAGE_UPDATE_ACTION_TAKEN: `${process.env.COMPLAINT_STREAM_NAME}.stage-update-action-taken`,
  ACTION_TAKEN: `${process.env.COMPLAINT_STREAM_NAME}.action-taken`,
  UPDATE_ACTION_TAKEN: `${process.env.COMPLAINT_STREAM_NAME}.update-action-taken`,
};
