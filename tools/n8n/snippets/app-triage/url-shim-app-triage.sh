...
declare -A __DOC_URLS=(
  ["workloads|latest"]="https://kubernetes.io/docs/concepts/workloads/controllers/deployment/"
  ["logging|latest"]="https://kubernetes.io/docs/concepts/cluster-administration/logging/"
)
