...
import { investigation_business_address } from "./investigation_business_address";
...
export class investigation_business {
  ...
  @ApiProperty({ isArray: true, type: () => investigation_business_address })
  investigation_business_address: investigation_business_address[];
