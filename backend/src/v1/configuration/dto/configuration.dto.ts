...
export class ConfigurationDto {
    ...
    @ApiProperty({
      ...
      @ApiProperty({
        ...
        description: "The timestamp when the configuration entry was created.  The timestamp is stored in UTC with no Offset.",
      })
      ...
      @ApiProperty({
        example: "2020-01-01 08:12:12",
        description: "The timestamp when the configuration entry was updated.  The timestamp is stored in UTC with no Offset.",
      })
