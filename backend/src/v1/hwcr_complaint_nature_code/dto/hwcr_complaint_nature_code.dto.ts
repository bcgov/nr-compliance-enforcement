...
export class HwcrComplainNatureCodeDto 
{
  ...
  @ApiProperty({ example: "Human injury/death", description: "The short description of the nature of the Human Wildlife Conflict code." })
  short_description: string;

  @ApiProperty({ example: "Human injury/death", description: "The long description of the nature of the Human Wildlife Conflict code." })
