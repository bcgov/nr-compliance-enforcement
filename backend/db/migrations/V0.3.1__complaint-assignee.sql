...
comment on column public.person_complaint_xref_code.active_ind is 'A boolean indicator to determine if the relationship type between a person and a complaint code is active.';
