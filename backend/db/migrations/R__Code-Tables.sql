...
on
conflict (staging_status_code) do nothing;
...
set short_description  = 'Daajing Giids (Queen Charlotte City)', long_description = 'Daajing Giids (Queen Charlotte City)'
where geo_organization_unit_code = 'QUEENCHA'