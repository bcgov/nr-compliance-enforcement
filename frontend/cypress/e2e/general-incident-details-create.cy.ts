...
describe("Complaint Create Page spec - Create View", () => {
  ...
  it("Navigate to the Complaint Create page & create and verify data", function () {
    ...
    cy.selectItemById("complaint-type-select-id", "General Incident Report");
    ...
    cy.selectItemById("general-incident-type-type-select-id", createCallDetails.generalIncidentType);
    ...
    cy.get('div[id="comp-nature-of-complaint"]').contains(createCallDetails.generalIncidentType);
