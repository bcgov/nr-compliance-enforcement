...
import { selectComplaintLargeCarnivoreInd, selectLinkedComplaints } from "@store/reducers/complaints";
    ...
    <Card id="outcome-assessment">
      <Card.Body>
        <dl>
          ...
          {(isLargeCarnivore || (assessment.assessment_type_legacy && assessment.assessment_type_legacy.length > 0)) &&
