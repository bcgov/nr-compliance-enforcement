...
export const AnimalOutcomeItem: FC<AnimalOutcomeProps> = ({ animalOutcome, handleDelete, handleEdit, indexItem }) => {
          ...
          <div className="comp-details-edit-column">
                  ...
                  <div className="flex-container">
                    ...
                    {animalOutcome?.sex && (
                      <>
                        ...
                        <div>{animalOutcome?.sex?.label}</div>
                      </>
                    )}
                    {animalOutcome?.age && (
                      <>
                        <div className="comp-margin-right-xs">,</div>
                        <div className="comp-margin-right-xs">{animalOutcome?.age?.label}</div>
                      </>
                    )}
            ...
            {from(animalOutcome?.tags).any() && (
              <div className="comp-details-edit-column">
                <div className="comp-details-label-input-pair">
                  <label className="comp-details-inner-content-label top">
                    Ear Tag{animalOutcome?.tags.length > 1 && "s"}
                  </label>
            ...
            {from(animalOutcome?.drugs).any() && (
              <div className="comp-details-edit-column">
                <div className="comp-details-label-input-pair">
                  <label className="comp-details-inner-content-label top">
                    Drug{animalOutcome?.drugs.length > 1 && "s"}
                  </label>
                  <div className="comp-animal-outcome-fill-space">
