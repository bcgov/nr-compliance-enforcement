...
export const InspectionHeader: FC<InspectionHeaderProps> = ({ inspection }) => {
  ...
  const dateLogged = inspection?.openedTimestamp ? new Date(inspection.openedTimestamp).toString() : undefined;
  const lastUpdated = inspection?.openedTimestamp ? new Date(inspection.openedTimestamp).toString() : undefined;
