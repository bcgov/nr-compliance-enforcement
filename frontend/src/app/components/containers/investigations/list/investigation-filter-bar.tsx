  ...
  return (
    <div className="comp-filter-bar">
      ...
      <div className="filter-pills-container">
        ...
        {hasFilter("investigationStatus") && (
          <FilterButton
            id="investigation-status-filter-pill"
            label={statusOptions.find((option) => option.value === searchValues.investigationStatus)?.label || "Status"}
        ...
        {hasDateRange() && (
          <FilterButton
            id="investigation-date-range-filter-pill"
