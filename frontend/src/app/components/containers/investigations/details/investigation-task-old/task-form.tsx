...
export const TaskForm = ({ task, investigationGuid, onClose, onDirtyChange }: TaskFormProps) => {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      const input: CreateUpdateTaskInput = {
        ...
        taskCategoryTypeCode: value["task-category"] || "",
  ...
  useEffect(() => {
    if (task) {
      ...
      form.setFieldValue("task-remarks", task.remarks || "");
      form.setFieldValue("task-due-date", task.dueDate);
      ...
      form.setFieldMeta("task-status", (meta) => ({ ...meta, isDirty: false, isTouched: false }));
      form.setFieldMeta("task-remarks", (meta) => ({ ...meta, isDirty: false, isTouched: false }));
      form.setFieldMeta("task-due-date", (meta) => ({ ...meta, isDirty: false, isTouched: false }));
    }
