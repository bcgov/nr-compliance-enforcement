...
export const InvestigationExhibits: FC<Props> = ({ investigationGuid, investigationName, tasks = [] }) => {
  ...
  const queryVariables = useMemo(
    () => ({
      ...
      filters: {
        ...
        officerFilter: searchValues.officerFilter || undefined,
        intakeStartDate: searchValues.intakeStartDate || undefined,
        intakeEndDate: searchValues.intakeEndDate || undefined,
  ...
  const { data, isLoading } = useGraphQLQuery<{
    ...
    queryKey: [
      ...
      searchValues.intakeStartDate,
      searchValues.intakeEndDate,
      searchValues.sortBy,
