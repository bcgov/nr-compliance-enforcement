INSERT INTO shared.contact_method_type_code (
    ...
    ('ALTPHONE1', 'Alternate phone 1', 'Alternate phone 1', 10, FALSE, 'FLYWAY', NOW()),
    ('ALTPHONE2', 'Alternate phone 2', 'Alternate phone 2', 20, FALSE, 'FLYWAY', NOW()),
    ('EMAILADDR', 'Email address', 'Email address', 30, TRUE, 'FLYWAY', NOW()),
    ('PRIMPHONE', 'Primary phone', 'Primary phone', 40, FALSE, 'FLYWAY', NOW()),
