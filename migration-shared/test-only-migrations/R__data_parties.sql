...
(person_guid, first_name, middle_names, last_name, create_user_id, create_utc_timestamp, update_user_id, update_utc_timestamp, party_guid)
...
-- Insert people
INSERT INTO shared.person (person_guid,first_name,middle_names, last_name,create_user_id,create_utc_timestamp,update_user_id,update_utc_timestamp,party_guid) VALUES
	 ('a80ec49d-ebbe-4642-a730-6778b79e8401','Michael',NULL,'Scott','system',NOW(),'system',NOW(),'6c65e099-7c32-429b-abdf-c5ccda9c9779'),
	 ('453ce7f8-0ddb-4fa8-8d84-1ac749e75b6a','Selma',NULL,'Berger','system',NOW(),'system',NOW(),'4f5a201a-fbdd-40db-9da1-119d465ce204'),
	 ('9602e6c9-277c-4f14-aca2-ccee7c951034','Emerson',NULL,'Higgins','system',NOW(),'system',NOW(),'21e5d3ba-a4b1-4d19-8c8a-147d8d5cba49'),
	 ('854e0e79-bf6a-4cd5-9333-61715d341dc6','Elijah',NULL,'Travis','system',NOW(),'system',NOW(),'15f6d336-c98e-4165-93e9-f3cad6f11b18'),
	 ('9c55db2f-8e08-4b57-a583-41ee4b0419b6','Jared',NULL,'Curtis','system',NOW(),'system',NOW(),'edf23f0f-e6fd-49aa-84f1-ac57f4931dfd'),
	 ('e4273e82-808f-4e1f-982e-083e8ff492c0','Juliet',NULL,'Conrad','system',NOW(),'system',NOW(),'2f219a8a-825a-43f8-84b8-ac0895adaad6'),
	 ('05dff431-f812-4f78-99bb-524b19211c5d','Jeffrey',NULL,'Clayton','system',NOW(),'system',NOW(),'b926c308-f2c3-42b7-a0ff-b635a954141a'),
	 ('b08e7932-ab12-474a-b105-53cba16b510a','Jay',NULL,'Lopez','system',NOW(),'system',NOW(),'071d03d0-d3d8-488a-8660-d01b59d07b02'),
	 ('a3ba4d5d-396b-41dd-bbf7-2b37047bde47','Dewayne',NULL,'Ewing','system',NOW(),'system',NOW(),'6f03b8ea-e389-4f80-9af0-19b2a52b4424'),
	 ('c5c27af6-48d0-4dfa-9305-0206260e0291','Stella',NULL,'Khan','system',NOW(),'system',NOW(),'3f514e91-0c25-471e-af65-d337aedab196'),
	 ('ddb322f3-d0bb-4888-b647-aa31e91b60a8','Joan',NULL,'Matthews','system',NOW(),'system',NOW(),'d7f734a3-988c-4420-945f-60e5a3c2f43f'),
	 ('444037f1-8a70-45df-94f8-743127836c1b','Gustavo',NULL,'Smith','system',NOW(),'system',NOW(),'fb845379-e684-4598-9bed-ed9b81e51f41'),
	 ('1b0adb9b-9d9f-4f8e-aeab-684dd88fe8c9','Mary',NULL,'Randall','system',NOW(),'system',NOW(),'f3cb9906-e50a-48ca-93b3-5d21eb54eafb'),
	 ('0c52b0f4-65c7-4eed-b7c1-a27d5a387b06','Monica',NULL,'Watkins','system',NOW(),'system',NOW(),'6532c891-afa2-444b-a7ef-e19fef8a1340')
ON CONFLICT DO NOTHING;   
