...
---------------------------------
INSERT INTO investigation.task_sub_type_code (
    task_sub_type_code, task_type_code, short_description, long_description, display_order, active_ind, create_user_id, create_utc_timestamp
) VALUES
...
ON CONFLICT (task_sub_type_code) DO UPDATE SET
